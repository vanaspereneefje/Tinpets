    ...
    <div className='flex flex-col items-center justify-center p-4'>
      ...
      <Accordion type="single" collapsible className='w-full max-w-xl'>
          ...
          <AccordionItem value="item-3">
              <AccordionTrigger className="text-lg font-bold">What types of pets are available for adoption?</AccordionTrigger>
              <AccordionContent className="text-md ">
        ...
        <AccordionItem value="item-4">
              <AccordionTrigger className="text-lg font-bold">Do you have a physical location?</AccordionTrigger>
              <AccordionContent className="text-md ">
        ...
        <AccordionItem value="item-5">
              <AccordionTrigger className="text-lg font-bold" >How can I contact you?</AccordionTrigger>
              <AccordionContent className="text-md ">
